...
<!-- Keywords: add your own, e.g.
[Green Finance]{.kw-topic} [Monetary Policy]{.kw-topic} [Descriptive analysis]{.kw-method}
-->

<!-- ABSTRACT PENDING: publisher page blocked automated retrieval.
     Paste the official abstract between the <summary> line and </details>. -->
...
[Not peer reviewed.]{.pub-meta}

<!-- Keywords: add your own, e.g.
[Green Finance]{.kw-topic} [EU Taxonomy]{.kw-topic}
-->
